...
const CATEGORY_MAP = {
  ...
  Loop:      { cat: 'ctrl', label: 'FOR LOOP',   color: '#f5a623' },
  Stop:      { cat: 'ctrl', label: 'BREAK',      color: '#eb5757' },
  Function:  { cat: 'stmt', label: 'FUNCTION',   color: '#7170ff' },
  Call:      { cat: 'expr', label: 'CALL',       color: '#38bdf8' },
  Return:    { cat: 'ctrl', label: 'RETURN',     color: '#ff6363' },
